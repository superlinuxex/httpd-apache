...
class TestHTTPDExTemplate:
    ...
    def test_httpd_ex_template_inside_cluster(self):
        ...
        assert self.oc_api.deploy_template(
            template=template_json, name_in_template="httpd-example", expected_output="Bienvenido1 Welcome to your static httpd",
        ...
        assert self.oc_api.check_response_inside_cluster(
            name_in_template="httpd-example", expected_output="Bienvenido1 Welcome to your static httpd"
        )
